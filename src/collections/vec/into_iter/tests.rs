...
mod tests {
    ...
    // ── Crate Aliases ───────────────────────────────────────────────────────
    use std::vec::IntoIter; // Test with the Standard Library's `IntoIter` first
    //use crate::collections::vec::IntoIter;

    // ── Method Tests ────────────────────────────────────────────────────────
    mod methods {
        use super::*;

        // ── `IntoIter::allocator()` Tests ───────────────────────────────────
        // TODO
        mod allocator {
            use super::*;
    ...
    mod blanket_trait_implementations {
        ...
        mod clone_to_uninit {
            ...
            mod methods {
                ...
                // ── `CloneToUninit::clone_to_uninit()` Tests ────────────────
                // TODO
                mod clone_to_uninit {
                    use super::*;
